              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Container(
                      width: double.infinity,
                      padding: const EdgeInsets.only(right: 35), // Space for delete button
                      child: Text(
                        widget.item['name'] ?? '',
                    ...
                    if ((widget.item['sku'] as String?) != null && (widget.item['sku'] as String).isNotEmpty)
                      Text(
                        '(SKU: ${widget.item['sku']})',
                        style: TextStyle(
                          fontSize: 12,
                    ...
                    if (widget.item['type'] == 'kit' && 
                      ...
                      GestureDetector(
                        ...
                        child: Row(
                          children: [
                            Text(
                              _isExpanded ? 'Hide Kit Includes ▲' : 'View Kit Includes ▼',
                              style: const TextStyle(
                                fontSize: 13,
                      ...
                      SizeTransition(
                        ...
                        child: Column(
                          children: [
                            ...
                            ...List<Widget>.from(((widget.item['kitItems'] as List<dynamic>?) ?? []).map((kit) {
                              final String numStr = (kit['num']?.toString() ?? '').padLeft(2, '0');
                              final String nameStr = (kit['name']?.toString() ?? '');
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                      child: Text(
                                        ...
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        style: const TextStyle(fontSize: 12, color: Color(0xFF151D51)),
                                      ),
                                    ),
                                    const SizedBox(width: 8),
                                    Text(
                                      '(QTY: $qty)',
                                      style: const TextStyle(fontSize: 11, color: Color(0xFF151D51), fontWeight: FontWeight.w600),
                                    ),
                                  ],
                                ),
                              );
