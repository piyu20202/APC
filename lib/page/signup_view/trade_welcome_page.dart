        ...
        Container(
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(text: ' in our industry, you\'re in the right place. To keep things running smoothly for our existing installers and resellers, all new registrations go through a '),
                TextSpan(
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildWelcomeListItem('• Automatic gate and boom gate installers (including gate and fencing fabricators)'),
                ...
                _buildWelcomeListItem('• Retail/wholesale supply chain professionals'),
              ],
            ),
          ),
          ...
          RichText(
            text: TextSpan(
              ...
              children: [
                ...
                TextSpan(
                  text: 'fill out the application form completely and accurately',
                  style: TextStyle(fontWeight: FontWeight.bold),
                ),
          ...
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                _buildWelcomeListItem('• We don\'t offer credit terms.', isBold: true),
                _buildWelcomeListItemWithBold('• If you\'re placing a one-off or occasional order, please use our regular website ordering process to avoid delays.'),
              ],
            ),
          ),
                ...
                child: ElevatedButton(
                  onPressed: _agreeToTerms ? () {
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(
                        content: Text('Please accept the terms and conditions to enable this button'),
