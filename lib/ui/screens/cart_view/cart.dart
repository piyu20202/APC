  ...
  List<Map<String, dynamic>> cartItems = [
    {
      ...
      'kitItems': [
        {
          'num': '01',
          'name': 'APC Proteous 5000 Italian Made Super Duty...',
          'qty': 1,
        },
        {'num': '02', 'name': 'APC Simply 24V Universal Control Box', 'qty': 1},
        {
          'num': '03',
          'name': 'Standard AC/DC Powered with 2m Cable for...',
          'qty': 1,
        },
        {'num': '04', 'name': 'APC Four Button Keyring Remote', 'qty': 2},
        {
          'num': '05',
          'name': 'APC Link 2 WiFi Switch - DUAL Relay WiFi...',
          'qty': 1,
        },
        {
          'num': '06',
          'name': 'APC Retro Reflective Safety Sensor - fo...',
          'qty': 1,
        },
        {
          'num': '07',
          'name': 'Two FREE Sunvisor Remote Controls (Promo...',
          'qty': 2,
        },
      ],
    },
